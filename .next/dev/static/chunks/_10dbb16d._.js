...
function LoginPage() {
    ...
    const handleForgotPassword = async (e)=>{
        ...
        setLoading(true);
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.resetPasswordForEmail(resetEmail, {
...
_s(LoginPage, "uMM23wDRHvfVqI1+Xt+h5K9FdQE=", false, function() {
    return [
